...
<template>
    <div class="wp_cell_gift">
        <div class="gift-container-info">
            <div class="gift-title">{{gift_title}}</div>
            <div class="gift-desc">{{gift_desc}}</div>
            <div class="gift-progress">
                <div class="line-container">
                    <div class="line-width" v-bind:style="{width:real_width}"></div>
                </div>
                <div class="line-text">剩余{{real_width}}</div><!----></div>
        </div>
        <div class="gift-btn gift-normal">{{git_btn_text}}</div>
    </div>
</template>
